...
class tf_gui:
    ...
    def create_transformations_menu( self ):
        ...
        with dpg.tree_node( label = "Scaling", parent = transformation_menu ):
            with dpg.group( horizontal = True ):
                with dpg.tooltip( dpg.add_text( "About (x, y, z):" )):
                    dpg.add_text( "The point at which to scale about.\nDefault at origin." )
        ...
        with dpg.tree_node( label = "Rotation", parent = transformation_menu ):
            ...
            with dpg.group( horizontal = True ):
                ...
                dpg.add_input_text( hint = "1, 1, 1", width = 100 )
            dpg.add_spacer( height = 5 )
            with dpg.group( horizontal = True ):
        ...
        with dpg.theme( ) as global_theme:
           # Window Theme
            with dpg.theme_component( dpg.mvWindowAppItem ):
                ...
                dpg.add_theme_style( dpg.mvStyleVar_WindowRounding, 10, category = dpg.mvThemeCat_Core )  # Rounded window corners
            ...
            with dpg.theme_component( dpg.mvButton ):
                ...
                dpg.add_theme_color( dpg.mvThemeCol_Text, ( 255, 255, 255 ), category = dpg.mvThemeCat_Core )  # White text on buttons
            ...
            with dpg.theme_component( dpg.mvInputFloat ):
                dpg.add_theme_color( dpg.mvThemeCol_FrameBg, darker_bg, category = dpg.mvThemeCat_Core )
            ...
            with dpg.theme_component( dpg.mvSliderFloat ):
                dpg.add_theme_color( dpg.mvThemeCol_SliderGrab, prim_color, category = dpg.mvThemeCat_Core )
                dpg.add_theme_color( dpg.mvThemeCol_FrameBg, darker_bg, category = dpg.mvThemeCat_Core )
                dpg.add_theme_color( dpg.mvThemeCol_FrameBgHovered, ( 235, 240, 255 ), category = dpg.mvThemeCat_Core )
                dpg.add_theme_color( dpg.mvThemeCol_Text, text_color, category = dpg.mvThemeCat_Core )
                dpg.add_theme_style( dpg.mvStyleVar_FrameRounding, 2, category = dpg.mvThemeCat_Core )
